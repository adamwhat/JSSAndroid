...
public class XMLRPCClient extends XMLRPCCommon {
	...
	public XMLRPCClient(URI uri) {
		...
		HttpParams clientHttpParameters = new BasicHttpParams();
		// Set the timeout in milliseconds until a connection is established.
		HttpConnectionParams.setConnectionTimeout(clientHttpParameters, 6000);
		// Set the default socket timeout (SO_TIMEOUT) 
		// in milliseconds which is the timeout for waiting for data.
		HttpConnectionParams.setSoTimeout(clientHttpParameters, 10000);

		client = new DefaultHttpClient(clientHttpParameters);
	}
